...
public class AttributeDataApp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		context.setAttribute("Name", "Amit");
		context.setAttribute("Address", "Bengaluru");
		
		out.println("<html><head><title>Attribute Data</title></head>");
		out.println("<body>");
		out.println("<center>");
		out.println("<h1 Style= 'color:blue; trext-align:center;'>Dynamic Information in Application scope...</h1>");
